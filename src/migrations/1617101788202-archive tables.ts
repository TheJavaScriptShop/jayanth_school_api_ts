...
export class archiveTables1617101788202 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Examinations_Archive" ("createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "id" SERIAL NOT NULL, "examName" character varying NOT NULL, "subjectName" character varying NOT NULL, "totalMarks" integer NOT NULL, "maxTime" integer, "teacherId" integer, "academicYearId" integer, CONSTRAINT "PK_088d55093912a7a276c746ad855" PRIMARY KEY ("id"))`);
