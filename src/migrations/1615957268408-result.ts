...
export class result1615957268408 implements MigrationInterface {
    name = 'result1615957268408'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Student" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "gender" character varying NOT NULL, CONSTRAINT "PK_dc3573f6f2de5aa3aefca0c1f1a" PRIMARY KEY ("id"))`);
